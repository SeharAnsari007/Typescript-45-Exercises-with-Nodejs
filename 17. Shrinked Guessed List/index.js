...
while (guestList.length > 2) {
    ...
    console.log("Sorry ".concat(removedGuest, "! You are not invited on dinner"));
}
console.log("Invitation to the last two guests");
guestList.forEach(function (lastGuests) { return console.log("Hello ".concat(lastGuests, "! Luckily you are still invited for dinner")); });
guestList.pop();
guestList.pop();
